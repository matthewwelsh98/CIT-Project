...
if (isset($_POST['submit'])) {
    ...
    $choices[4] = htmlspecialchars($_POST['choice4']);
     ...
     // english quiz question query
    $query = "INSERT INTO `3047_englishquiz` (question_number, text)VALUES ('$question_number','$question_text')";
   ...
   // English Choice Query
                $query = "INSERT INTO `3047_englishquizchoices` (question_number, is_correct, text) VALUES ('$question_number','$is_correct','$value')";
        ...
        // message display the following
           $msg = "  <div class='container'>
               ...
               <a href='englishquiz.php'><button class='btn btn-success'> Finish </button> </a>
        </div>
...
";
       ...
       //select all from the english quiz query
   ...
   <div class="container">
                ...
                <div class="col-sm-12 col-md-12  col-lg-12 ">
                    ...
                    <div class="text-center">
                        ...
                        <p> Teacher, here you can add questions to the English Spelling Quiz !   </p>     
                    </div>
                    <hr class="my-4"> <br>
   ...
   if (e == "") {
    ...
    return false;
         ...
         <div class="container">
             ...
             <form method="POST" action="englishaddquestions.php" onsubmit="return validateForm()" name='questionform'  
                 ...
                 <p>
                  ...
                  <p>
                     ...
                     <input type="text" style="width:40%" name="choice4" placeholder='5th choice, G0!' />  
                 </p>  
