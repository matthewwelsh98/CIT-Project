...
// Get the delete id from the table
...
//go back to this page after delete completed. 
 echo'<script type="text/javascript">
    ...
    header = ("Location: http://mwelsh04.web.eeecs.qub.ac.uk/PrimaryLearn/mathsquestiondeleted.php?mathsquizid=$deleteid")</script>';
 
 
 // maths delete query here
$mathsdeletequery = "DELETE 3047_mathsquiz, 3047_quizchoices
FROM 3047_mathsquiz
INNER JOIN 3047_quizchoices
WHERE 3047_mathsquiz.question_number = 3047_quizchoices.question_number
AND 3047_mathsquiz.question_number = '$deleteid'";

// run the result
$results = $conn -> query($mathsdeletequery);
...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
 ...
 <?php if($utype == 1 || $utype == 2){echo"<a href='profile.php'>Parents</a>";
        ...
        <div class="alert alert-success text-center">
         ...
         <a href='mathsquiz.php'<button class='btn btn-success' type='submit'> Finish</button></a>
     </div>
     </div>
