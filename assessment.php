...
$id = $conn->real_escape_string($_GET['subid']);

//QUERY TO SELECT BY subject_id
$full_read = "SELECT * FROM 3047_assessment WHERE subject_id= '$subid'";

$catergory = "SELECT * FROM 3047_ass_file";

$getresult = $conn->query($full_read);

$catresult = $conn->query($catergory);
...
<?php if($utype == 1 || $utype == 2){echo"<a href='profile.php'>Parents</a>";
        ...
        <div class="container-fluid bg-3 text-center">
            <div class="row">
                ...
                <h1>See below children for subject assessments!</h1>
                <hr class =light"/>
		...
		while($row = $getresult->fetch_assoc()){
			...
			echo " <a href='viewassessment.php?assessmentid=$iddata'></br>
				<div class='row'><br><h4>$asstitle  <span class='glyphicon glyphicon-ok'></span></h4><br></div></a>";
