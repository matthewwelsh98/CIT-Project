...
// select all from the maths quiz query 
...
// get the user id from the db through the session
...
<div class="col-md-12">
            ...
            <h4> <?php echo" You Earned + <b>1</b> Point towards a star!
                   <br>
               "; ?> </h4>
            <a href='mathsquizquestions.php?n=1'><button class='btn btn-warning'>Retake Quiz</button>  </a>   
            <a href='mathsquiz.php'><button class='btn btn-success'> Finish </button> 
...
$querystars = $conn->query("UPDATE 3047_star_total SET total = $points + '1' WHERE user_id = '$user'");
          ...
          echo      "<div class='col-sm-12 col-md-12  col-lg-12 '>
            ...
            <div class='container text-center'>
                        ...
                        <h1><span class='glyphicon glyphicon-ok'></span> Quiz has been completed but not full marks. Please try again!!</h1>
...
";
          ...
          {         
            ...
            echo    "  <div class='text-center'>
                        <h1><span class='glyphicon glyphicon-ok'></span> A disappointing result. Please try again!!!!</h1>
