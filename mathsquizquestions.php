...
$mathsnumber = (int) $conn->real_escape_string($_GET['n']);
...
$quizquery1 = "SELECT * FROM 3047_mathsquiz WHERE question_number = $mathsnumber";
...
$mathsquestion = $result->fetch_assoc();

// get query from maths number
$quizquery = "SELECT * FROM 3047_quizchoices WHERE question_number = $mathsnumber";
...
function validateForm() {
  ...
  if (x == "") {
   ...
   <!-- maths sums questions -->
                    <div class="text-center">
                        <h2><span class="glyphicon glyphicon-pencil"></span>FUN TIME WITH MATHS SUMS!</h2>
            ...
            <div class="container ">      
                ...
                <div class="current">Question <?php echo $mathsquestion['question_number']; ?> of <?php echo $total; ?></div>
                <p class="question">

                    <b><?php echo $mathsquestion ['text']; ?></b>
                ...
                <!-- post questions to quiz -->
                <form method="POST" action="mathsquizprocess.php" name='quizform' onsubmit="return validateForm()"> 
 ...
 <?php endwhile; ?> 
                    ...
                    <input type="hidden" name="number" value="<?php echo $mathsnumber; ?>" />
                </form>
