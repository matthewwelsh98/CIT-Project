...
//Query and select all from the maths quiz table
...
<center><img src="images/animated_maths_quiz.png" alt=""/></center>
...
// If the user is a teacher allow them to see the quiz, add questions and delete questions to the quiz. 
            if ($utype == 3) {
                ...
                <div class='col-sm-12 col-md-12  col-lg-12 '>
                    ...
                    <div class='text-center'>
                        ...
                        <h4><b><p> View, Add and Delete Quiz Questions below ! </p></b></h4>   
                    </div>
                    <hr class='my-4'> <br>
        ...
        <?php
        echo "  <a href='mathsquizquestions.php?n=1'><button class='btn btn-warning'>View Quiz</button>  </a>         
                    <br><br>
          ...
          echo "<div class='container'>
                ...
                <div class='col-sm-12 col-md-12  col-lg-12 '>
                    ...
                    <div class='text-center'>
                        ...
                        <p> Add more questions to the Maths quiz !   </p>     
                    
                    <hr class='my-4'> <br>

            
            <a href='mathsaddquestions.php'><button class='btn btn-success'>Insert Questions</button>  </a>        
</div>
                </div>
            </div>
            <br><br>
        ...
        echo "<div class='container'>
                ...
                <div class='col-sm-12 col-md-12  col-lg-12 '>
                    ...
                    <div class='text-center'>
                        ...
                        <p> Delete questions from the Maths quiz !   </p>     
                    
                    <hr class='my-4'> <br>

            
            <a href='mathsdeletequestions.php'><button class='btn btn-danger'>Delete Questions</button>  </a>        
</div>
                </div>
            </div>
            <br><br><br>
...
// If the user is a student or parent, only show the quiz questions and answers.  
            ...
            <div class='container text-center'>
                <div class='col-sm-12 col-md-12  col-lg-12 '>
                    <p>Welcome this is the fun maths quiz!</p>
                    <ui>
        ...
        <?php
        echo "  <a href='mathsquizquestions.php?n=1'><button class='btn btn-success'>Let's go!</button>  </a>         
                    <br><br>
