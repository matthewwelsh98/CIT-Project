...
if ($_POST) {
 ...
 // get the correct answer
    ...
    $processquery = "SELECT * FROM `3047_englishquizchoices` WHERE question_number = $number AND is_correct = 1";
    ...
    if ($number == $total) {
        header("Location: englishquizfinal.php");
        exit();
    } else {
        header("Location: englishquizquestions.php?n=" . $next);
    }
}
